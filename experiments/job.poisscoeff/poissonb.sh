...
# sbatch -p mzhang,pool1 -t 1-00:00:00 --mem=82Gb -o /projects/zhanglab/users/ana/logs/create_ctrl_%J.err -J "ctrl_$BIN_CONFIG" --wrap " \
# source ~/.bashrc && \
# conda activate ctar && \
...
# Submit create_ctrl job
sbatch -p mzhang,pool1 -t 1-00:00:00 -x compute-1-1 --mem-per-cpu 4Gb -n 1 -c 16 \
...
# sbatch -p mzhang,pool1 -t 1-00:00:00 -x compute-1-1 --mem-per-cpu 4Gb -n 1 -c 16 --array 0 --mail-type=END --mail-user=asprieto@andrew.cmu.edu \
#   -o /projects/zhanglab/users/ana/logs/compute_pr_%A_%a.err -J "pr_$BIN_CONFIG" --wrap " \
#   source ~/.bashrc && \
#   conda activate ctar && \
#   python /projects/zhanglab/users/ana/cts_peak_gene/CLI_ctar.py \
#       --job compute_pr \
