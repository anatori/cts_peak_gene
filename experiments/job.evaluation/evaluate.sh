...
AGG_DIR="${AGG_DIR:-/projects/zhanglab/users/ana/multiome/validation/overlap/${DATASET_NAME}}"
...
echo "Submitting merge_methods.py ..."
MERGE_JOB_ID=$(submit \
  --dependency=afterok:${AGG_JOB_ID} \
  -t 1-00:00:00 --mem=128G -J "merge_${DATASET_NAME}" \
