...
TARGET_PATH=/projects/zhanglab/users/ana/multiome/simulations/bin_analysis/5054833_5.5.5.5.10000_results/float64/5087804_results
...
BATCH_SIZE=20
RESULTS_PATH=/projects/zhanglab/users/ana/multiome/simulations/bin_analysis/5054833_5.5.5.5.10000_results/float64/5087804_results
...
sbatch -p mzhang,pool1 -t 3-00:00:00 -x compute-1-1 $ARRAY_OPT --mem-per-cpu 8Gb -n 1 -c 16 --mail-type=END --mail-user=asprieto@andrew.cmu.edu \
  -o /projects/zhanglab/users/ana/logs/compute_%A_%a.err -J "pr_float64_$BIN_CONFIG" --wrap " \
  source ~/.bashrc && \
  conda activate ctar && \
  python /projects/zhanglab/users/ana/cts_peak_gene/CLI_ctar.py \
