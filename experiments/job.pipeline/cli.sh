...
MULTIOME_FILE=/projects/zhanglab/users/ana/multiome/raw/neatseq/neat.h5mu
TARGET_PATH=/projects/zhanglab/users/ana/multiome/simulations/bin_analysis/neatseq/studentized/5111948_results
GENOME_FILE=/projects/zhanglab/users/ana/bedtools2/ana_bedfiles/ref/GRCh38.p14.genome.fa.bgz
BIN_CONFIG=3.3.3.3.10000
BIN_TYPE='mean_var'
PYBEDTOOLS_PATH=/projects/zhanglab/users/ana/bedtools2/bin
BATCH_SIZE=20
RESULTS_PATH=/projects/zhanglab/users/ana/multiome/simulations/bin_analysis/neatseq/studentized/5111948_results
